...
We'll call them tags. Maybe Racket printer could be coerced to print ':foo as
:foo? This only really ever matters in REPL and logging, I guess.
...
*** TODO syntax highlight :tags in racket-mode

...
*** TODO Implement define/table

**** TODO allow id-style (define t.k val)

**** TODO allow function-nesting (define ((foo.bar a) b) body)

**** TODO replace Racket's define

*** TODO Expand t..k and t::k syntax

*** TODO Implement t..k and t::k semantics

...
*** TODO #:spec or #:declare keyword argument in {<mt>}
...
*** TODO t.key t:key t..key t::key syntax
...
*** TODO [#C] . and : operators in app position
...
*** NOTE on method combinations (:before, :after, call-next-method)
...
*** TODO isa, isa? and identity in multiple inheritance
